...
class CustomerController:
    @classmethod
    def save(cls, first_name, last_name, mobile_number, address):
        try:
            customer = Customer(None, first_name, last_name, mobile_number, address)
            customer.validate()
    ...
    @classmethod
    def update(cls, customer_id, first_name, last_name, mobile_number, address):
        try:
            customer = Customer(customer_id, first_name, last_name, mobile_number, address)
            customer.validate()
