...
class Sale:
    def __init__(self, sale_id, car_id, customer_id, employee_id, date_time, final_cost):
    ...
    def to_tuple(self):
        return tuple((self.sale_id, self.car_id, self.customer_id, self.employee_id, self.date_time, self.final_cost))