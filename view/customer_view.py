...
class CustomerView:
    def __init__(self):
        ...
        self.customer_id = LabelWithEntry(self.window, "CustomerId", 20, 60, data_type=IntVar)
    ...
    def save_click(self):
        status, message = CustomerController.save(self.customer_id.get(), self.first_name.get(), self.last_name.get(),
    ...
    def edit_click(self):
        status, message = CustomerController.update(self.id.get(), self.customer_id.get(), self.first_name.get(),
                                                    self.last_name.get(), self.mobile_number.get(), self.address.get())
        if status:
